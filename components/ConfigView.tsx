...
const ConfigView: React.FC<ConfigViewProps> = ({
    ...
    return (
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <label
                            ...
                            onDrop={handleDrop}
                            className={`flex justify-center w-full px-6 pt-5 pb-6 border-2 border-gray-600 border-dashed rounded-md cursor-pointer transition-colors ${isDragging ? 'border-cyan-400 bg-gray-700/50' : 'hover:border-gray-500'}`}
                        >
                         ...
                         {uploadedFiles.length > 0 && (
                            <div className="mt-4 space-y-2">
                                {uploadedFiles.map((file, index) => (
                                    <div key={index} className="flex items-center justify-between bg-gray-700/50 p-2 rounded-md text-sm">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            className={`w-full bg-gray-900 border rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500 text-gray-200 p-2 ${urlError ? 'border-red-500' : 'border-gray-600'}`} 
                            placeholder="https://...&#10;https://..."
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
                ...
                <div className="space-y-4">
                     <div>
                        ...
                        <input type="text" id="exam-code" value={examCode} onChange={(e) => setExamCode(e.target.value)} className="w-full bg-gray-900 border border-gray-600 rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500 text-gray-200 p-2" placeholder="ex: AZ-900, CCNA 200-301" />
                    </div>
                    <div>
                        <label htmlFor="question-count" className="block text-sm font-medium text-gray-300 mb-2">Número de Questões</label>
                        <input type="number" id="question-count" value={questionCount} onChange={(e) => setQuestionCount(Number(e.target.value))} min="1" max="50" className="w-full bg-gray-900 border border-gray-600 rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500 text-gray-200 p-2" />
                    </div>
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 flex flex-col justify-between">
                 <div>
