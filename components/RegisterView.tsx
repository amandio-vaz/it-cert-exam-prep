        ...
        <div className="flex items-center justify-center min-h-[70vh]">
            <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-slate-900/50 backdrop-blur-sm border border-gray-200 dark:border-slate-700/50 rounded-2xl shadow-2xl">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400">Comece sua jornada de certificação hoje.</p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                 ...
                 <p className="text-center text-xs text-gray-500">
                    Você receberá um link mágico no seu e-mail para autenticação.
                </p>
                <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                    Já tem uma conta?{' '}
                    <button onClick={onSwitchToLogin} className="font-medium text-violet-500 hover:text-violet-400">
                        Faça login
                    </button>
                </p>
            </div>
